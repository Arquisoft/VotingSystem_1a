...
public class Comprobador {
	...
	public static boolean comprobacionDatosParser(String nombre, String NIF, String email, String codigoMesa) {

		if (nombre.isEmpty() || NIF.isEmpty() || email.isEmpty() || codigoMesa.isEmpty()) {
